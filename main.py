...
threading.Thread(target=print_watermark, args=(watermark,)).start()

version = 'WineCraft Alpha 1.0'
...
class App(cs.CTk):
    def __init__(self):
        ...
        # Banner animation
        threading.Thread(target=label_animation, args=(self.banner_var, version)).start()
